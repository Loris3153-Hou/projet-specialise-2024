...
<div id="page4">
    <div id="page4-det">
        <h1 class="titre-border">Meuble de votre chambre</h1><br><br>
        <table>
          <tr>
            <td>
              <form action="" method="get" class="page4-det-col">
                <h3>Lit</h3>
                <label for="larg-lit">Largeur :</label>
                <input type="text" name="larg-lit" id="larg-lit">
                <label for="long-lit">Longueur :</label>
                <input type="text" name="long-lit" id="long-lit">
                <label for="haut-lit">Hauteur :</label>
                <input type="text" name="haut-lit" id="haut-lit">
                <input type="button" id="form-lit" value="Ajouter +" class="page3-info-form-button">
              </form>
            </td>
          </tr>
          <tr>
            <td>
              <form action="" method="get" class="page4-det-col">
                <h3>Table de nuit</h3>
                <label for="larg-table">Largeur :</label>
                <input type="text" name="larg-table" id="larg-table">
                <label for="long-table">Longueur :</label>
                <input type="text" name="long-table" id="long-table">
                <label for="haut-table">Hauteur :</label>
                <input type="text" name="haut-table" id="haut-table">
                <input type="button" id="form-table" value="Ajouter +" class="page3-info-form-button">
              </form>
            </td>
          </tr>
          <tr>
            <td>
              <form action="" method="get" class="page4-det-col">
                <h3>Bureau</h3>
                <label for="larg-bureau">Largeur :</label>
                <input type="text" name="larg-bureau" id="larg-bureau">
                <label for="long-bureau">Longueur :</label>
                <input type="text" name="long-bureau" id="long-bureau">   
                <label for="haut-bureau">Hauteur :</label>
                <input type="text" name="haut-bureau" id="haut-bureau">
                <input type="button" id="form-bureau" value="Ajouter +" class="page3-info-form-button">
              </form>           
            </td>
          </tr>
          <tr>
            <td>
              <form action="" method="get" class="page4-det-col">
                <h3>Autres</h3>
                <label for="larg-autres">Largeur :</label>
                <input type="text" name="larg-autres" id="larg-autres">
                <label for="long-autres">Longueur :</label>
                <input type="text" name="long-autres" id="long-autres">      
                <label for="haut-autres">Hauteur :</label>
                <input type="text" name="haut-autres" id="haut-autres">
                <input type="button" id="form-autres" value="Ajouter +" class="page3-info-form-button">
              </form>        
            </td>
          </tr>
        </table>
...
<script>
  ...
  document.getElementById('suivant').addEventListener('click', function() {
    ...
    window.location.href = "{{ route('page5') }}?chambre_id=" + chambreId;
