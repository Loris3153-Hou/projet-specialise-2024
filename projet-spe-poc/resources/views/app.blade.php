...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container">
        ...
        <button id="bouton-js">bouton js</button>
        <button id="bouton-css">bouton css</button>
        <button id="bouton-laravel">bouton laravel</button>
    ...
    <script>
        ...
        document.getElementById('bouton-laravel').addEventListener('click', function() {
            var url = "{{ route('ajax') }}";
            ...
            fetch(url)
                ...
                .catch(error => {
                    // Gérer les erreurs
                    console.error('Erreur lors de la requêtgie Ajax:', error);
                });
        });
    </script>
    </body>
